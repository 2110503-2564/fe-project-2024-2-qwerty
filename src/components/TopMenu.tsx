        ...
        <div className = {styles.menucontainer}>
            ...
            <div className='flex flex-row items-center absolute right-0 h-full px-5 text-cyan-600 text-sm'>
            {
                session? <Link href = "/api/auth/signout">
                    <div className='flex items-center h-full px-5 text-cyan-600 text-sm'>Sign-Out of {session.user?.name}</div>
                </Link>
                :<Link href = "/login">
                    <div className='flex items-center h-full px-5 text-cyan-600 text-sm'>Sign-In</div>
                </Link>
            }
            </div>
        </div>
