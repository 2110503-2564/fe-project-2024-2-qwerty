  ...
  */
  ...
  return (
    <main className="text-center p-5">
      <h1 className="text-2xl">{venueDetail.data.name}</h1>
      <div className="flex flex-row my-5">
        ...
        <Link href={`/booking`}>
          <button className="block rounded-md bg-sky-600 hover:bg-indigo-600 px-3 py-1 text-white shadow-sm">Book Venue</button>
        </Link> 
        </div>
      </div>
    </main>
